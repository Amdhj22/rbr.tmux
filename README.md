...
`rbr.tmux` paints your tmux status bar, window tabs, pane borders, and prompts with the [RBR color scheme](https://github.com/Amdhj22/rbr) — **kerb red** for the focused pane and active window, **RB yellow** for session badges and messages. See the upstream [`STYLE-GUIDE.md`](https://github.com/Amdhj22/rbr/blob/main/STYLE-GUIDE.md) for the full design rules.
